...
(function () {
    ...
    const secrets = [
        ...
        { id: 17, name: "PIÑA_HOSHI.png", url: "assets/secrets/pina_hoshi.png", locked: true, desc: "<strong>[ ARCHIVO 017 ]</strong> <em>Rika dejó una nota:</em> “yo sólo dije que parecía piña porque parecía piña. no dije que alguien la dibujara llorando dentro de una. si Hoshi encuentra esto, yo no estuve aquí... pero sí me reí.”" },
        { id: 18, name: "TETO_HOSHI.png", url: "assets/secrets/teto_hoshi.png", locked: true, desc: "<strong>[ ARCHIVO 018 ]</strong> <em>Jun dejó una nota:</em> “hoshi en modo teto tiene demasiada energía de jefa final de karaoke. rika dijo que le quedaba bien y luego fingió que no había dicho nada. momento histórico, supongo.”" }
    ];
