...
(function () {
    ...
    const EN = {
        ...
        "Esto apenas es el medio tiempo! Nos vemos en noviembre en el festival @Pixelatl para presentar la version mas solida y caotica de nuestro proyecto. Felicidades a los seleccionados! Conoce el lobby oficial: cheatguys-cloudflare.pages.dev": "This is only halftime! See you in November at the @Pixelatl festival to present the strongest and most chaotic version of our project. Congratulations to the selected projects! Visit the official lobby: cheatguys-cloudflare.pages.dev",
        ...
        "¡Rompí la página de CheatGuys! por andar de curioso. Escanea el código o entra al arcade aquí: https://cheatguys-cloudflare.pages.dev/": "I broke the CheatGuys! page by being too curious. Scan the code or enter the arcade here: https://cheatguys-cloudflare.pages.dev/",
